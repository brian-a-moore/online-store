...
-- AddForeignKey
ALTER TABLE "user_store_relations" ADD CONSTRAINT "user_store_relations_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "stores"("id") ON DELETE CASCADE ON UPDATE CASCADE;
