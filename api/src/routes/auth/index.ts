...
import { changePasswordAuthController, loginAuthController, verifyTokenAuthController } from '../../controllers/auth';
import schemaValidatorMiddleware from '../../middlewares/schemaValidator.middleware';
import { changePasswordAuthSchema, loginAuthSchema, verifyTokenAuthSchema } from '../../schemas/auth';
