...
export type AuthLoginResponse = Response<{ id: string; token: string }>;
...
export type AuthVerifyTokenResponse = Response<{ user: { id: string }; refreshToken: string }>;
...
export type CreateItemResponse = Response<{ id: string }>;
...
export type DeleteItemResponse = Response<never>;
...
export type GetItemResponse = Response<{
  item: {
    id: string;
    productId: string;
    itemTypeId: number;
...
export type ListItemsPublicResponse = Response<{
  items: {
    id: string;
    name: string;
    description: string | null;
...
export type ListItemsPrivateResponse = Response<{
  items: {
    id: string;
    name: string;
    updatedAt: Date;
...
export type UpdateItemResponse = Response<never>;
...
export type CreateProductResponse = Response<{ id: string }>;
...
export type DeleteProductResponse = Response<never>;
...
export type GetProductPublicResponse = Response<{
  product: {
    id: string;
    name: string;
    description: string | null;
...
export type GetProductPrivateResponse = Response<{
  product: {
    id: string;
    storeId: string;
    name: string;
...
export type ListProductsPublicResponse = Response<{
  products: {
    id: string;
    name: string;
    description: string | null;
...
export type ListProductsPrivateResponse = Response<{
  products: {
    id: string;
    name: string;
    updatedAt: Date;
...
export type UpdateProductResponse = Response<never>;
...
export type CreateStoreResponse = Response<{ id: string }>;
...
export type DeleteStoreResponse = Response<never>;
...
export type GetStorePublicResponse = Response<{
  store: {
    id: string;
    name: string;
    description: string | null;
...
export type GetStorePrivateResponse = Response<{
  store: {
    id: string;
    name: string;
    website: string | null;
...
export type ListStoresPublicResponse = Response<{
  stores: {
    id: string;
    name: string;
    description: string | null;
...
export type ListStoresPrivateResponse = Response<{
  stores: {
    id: string;
    name: string;
    updatedAt: Date;
...
export type UpdateStoreResponse = Response<never>;
...
export type CreateUserResponse = Response<{ id: string; defaultPassword: string }>;
...
export type DeleteUserResponse = Response<never>;
...
export type UpdateUserResponse = Response<never>;
