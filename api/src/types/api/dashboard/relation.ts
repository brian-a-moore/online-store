...
export type UpdateStoreRelationDashboardBody = z.infer<typeof relationSchema.updateStoreRelationDashboardSchema.body>;
export type UpdateStoreRelationDashboardParams = z.infer<
  typeof relationSchema.updateStoreRelationDashboardSchema.params
>;
export type UpdateStoreRelationDashboardQuery = z.infer<typeof relationSchema.updateStoreRelationDashboardSchema.query>;

export type DeleteStoreRelationDashboardBody = z.infer<typeof relationSchema.deleteStoreRelationDashboardSchema.body>;
export type DeleteStoreRelationDashboardParams = z.infer<
  typeof relationSchema.deleteStoreRelationDashboardSchema.params
>;
export type DeleteStoreRelationDashboardQuery = z.infer<typeof relationSchema.deleteStoreRelationDashboardSchema.query>;
